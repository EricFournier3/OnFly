...
base_dir="/data/Runs/20200514_ctrl-metag-16s-blasto/metag/8_MAP_ON_REF/"
fastq_dir="/data/Runs/20200514_ctrl-metag-16s-blasto/metag/3_FASTQ_CLEAN_TRIMMOMATIC/"
samples=("metag-L00258931-molysisSA")

ref_list=("Malassezia furfur" "Klebsiella pneumoniae")
ref_list_=()
